...
//
// Classification is at the node's min_angle= if it names one, otherwise at
// kDefaultCreaseThresholdDeg. Neither depends on the target mesh or on the
// render variables, so both passes of fillet() classify at the same value
