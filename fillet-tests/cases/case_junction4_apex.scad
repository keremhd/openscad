// The convex counterpart of case_junction4_pocket: the bare square pyramid
// ($fn = 4 cone) -> round_tool. No hand reference; sandwich check only.
...
module case_model() cylinder(r1 = R, r2 = 0, h = HC, $fn = 4);
